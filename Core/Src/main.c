...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|MOTOR_IN1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : MOTOR_IN_2_Pin */
  GPIO_InitStruct.Pin = MOTOR_IN_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MOTOR_IN_2_GPIO_Port, &GPIO_InitStruct);
